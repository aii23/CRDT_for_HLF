...
import (
	...
	"github.com/hyperledger/fabric/integration/chaincode/crdt_erc20"
)
...
func main() {
	...
	go func() {
		// err := shim.Start(&crdt.CRDT1{})
		// if err != nil {
		// 	startErrChan <- err
		// }

		tokenChaincode, err := contractapi.NewChaincode(&crdt_erc20.SmartContract{})
